...
document.addEventListener("DOMContentLoaded", function () {
   const errorDetails = {
      400: {
         title: "SAI42 - Bad Request",
         description: "The server cannot process the request due to a client error."
      },
      401: {
         title: "SAI42 - Unauthorized",
         description: "Authentication is required to access this resource."
      },
      403: {
         title: "SAI42 - Forbidden",
         description: "You don't have permission to access this resource."
      },
      404: {
         title: "SAI42 - Not Found",
         description: "The requested resource could not be found."
      },
      408: {
         title: "SAI42 - Request Timeout",
         description: "The server timed out waiting for the request."
      },
      500: {
         title: "SAI42 - Internal Server Error",
         description: "The server encountered an unexpected condition."
      },
      503: {
         title: "SAI42 - Service Unavailable",
   ...
   if (errorInfo) {
      ...
      document.querySelector(".error-title").textContent = errorInfo.title.replace("SAI42 - ", "");
      document.querySelector("#source").textContent = errorInfo.description;
   } else {
      document.title = "SAI42 - Unknown Error";
